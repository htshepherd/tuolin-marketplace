...
from tuolin_marketplace.video_creation_agent import confirm_shots


def main() -> int:
    parser = argparse.ArgumentParser(description="Confirm Dreamina shot results for a Tuolin video creation run.")
    ...
    result = confirm_shots(Path(args.run_dir), now=now)
