...
from tuolin_marketplace.video_creation_agent import confirm_storyboard


def main() -> int:
    parser = argparse.ArgumentParser(description="Confirm storyboard and prompts for a Tuolin video creation run.")
    ...
    result = confirm_storyboard(Path(args.run_dir), now=now)
