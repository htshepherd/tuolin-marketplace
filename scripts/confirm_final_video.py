...
from tuolin_marketplace.video_creation_agent import confirm_final_video


def main() -> int:
    parser = argparse.ArgumentParser(description="Confirm final video for a Tuolin video creation run.")
    ...
    result = confirm_final_video(Path(args.run_dir), now=now)
