...
from tuolin_marketplace.video_creation_agent import submit_shot_retry


def main() -> int:
    parser = argparse.ArgumentParser(description="Submit one confirmed Dreamina shot retry for a Tuolin video creation run.")
