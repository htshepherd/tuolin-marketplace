...
from tuolin_marketplace.video_creation_agent import query_dreamina_results


def main() -> int:
    parser = argparse.ArgumentParser(description="Query Dreamina results for a Tuolin video creation run.")
    ...
    result = query_dreamina_results(Path(args.run_dir), execute=args.execute, dreamina_command=args.dreamina_command, now=now)
