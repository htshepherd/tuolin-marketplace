...
from tuolin_marketplace.video_creation_agent import confirm_video_plan


def main() -> int:
    parser = argparse.ArgumentParser(description="Confirm video_plan.md/json for a Tuolin video creation run.")
    ...
    result = confirm_video_plan(Path(args.run_dir), now=now)
